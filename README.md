...
1.Project Title / Headline Insurence Analytics: A Weekely Branch Insurence Dashboard dynamic ,interactive data visulization tool to built to explore insurence report data worldwide-focusing on No of Invoices,Total Cross Sell,Total Renewal ,Total Stage wise Revenue and Total Employee.
